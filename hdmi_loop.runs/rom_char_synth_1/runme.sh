...
HD_PWD='C:/Users/xuyi/Desktop/FPGA display/08_4_hdmi_loop/hdmi_loop.runs/rom_char_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_char.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_char.tcl
