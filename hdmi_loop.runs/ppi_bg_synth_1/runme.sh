...
HD_PWD='D:/FPGA_HDMI/08_4_hdmi_loop/hdmi_loop.runs/ppi_bg_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ppi_bg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ppi_bg.tcl
