...
HD_PWD='C:/Users/xuyi/Desktop/FPGA display/08_4_hdmi_loop/hdmi_loop.runs/bram_display_a_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_display_a.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_display_a.tcl
