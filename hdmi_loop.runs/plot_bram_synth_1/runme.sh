...
HD_PWD='D:/FPGA_HDMI/08_4_hdmi_loop/hdmi_loop.runs/plot_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log plot_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source plot_bram.tcl
