...
synth_design -top rom_theta_data -part xc7k325tffg900-2 -mode out_of_context

rename_ref -prefix_all rom_theta_data_

# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef rom_theta_data.dcp
