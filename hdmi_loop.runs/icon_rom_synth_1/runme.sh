...
HD_PWD='C:/Users/xuyi/Desktop/FPGA display/08_4_hdmi_loop/hdmi_loop.runs/icon_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log icon_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source icon_rom.tcl
