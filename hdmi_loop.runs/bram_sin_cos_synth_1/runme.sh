...
HD_PWD='C:/Users/Yi/Desktop/FPGA/08_4_hdmi_loop/hdmi_loop.runs/bram_sin_cos_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_sin_cos.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_sin_cos.tcl
